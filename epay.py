...
def epay_submit(order_data):
    ...
    try:
        request_api_url = API + 'submit.php'
        print(request_api_url)
        print(json.dumps(order_data))
        request_api_url = "https://epay.vgrpc.com/submit.php"
        req = requests.post(request_api_url, data=order_data, headers={'User-Agent': "vgrpc/python"})
